  ...
  return (
    <section>
      <div className="clients-container">
        ...
        {/* Clients list */}
        <div className="clients-list mt-24 mb-40 flex justify-center items-center text-center flex-wrap gap-20">
          <div className="clients-person w-64">
            ...
            />
            <h2 className="font-medium text-xl mt-5">Tyler The Creator</h2>
          ...
          <div className="clients-person  w-64">
            <img
              ...
              alt="Tyler_The_Destroyer"
            />
            <h2 className="font-medium text-xl mt-5">DaAdult</h2>
          ...
          <div className="clients-person  w-64">
            <img
              ...
              alt="Tyler_The_Destroyer"
            />
            <h2 className="font-medium text-xl mt-5">Kanye East</h2>
          ...
          <div className="clients-person  w-64">
            <img
              ...
              alt="Tyler_The_Destroyer"
            />
            <h2 className="font-medium text-xl mt-5">Travis Scott</h2>
